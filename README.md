...
1. What is React JS and what problems does it solve? Support your answer with concepts introduced in class and from your personal research on the web.
   DOM operations can be expensive and take a lot of time to load code. Instead of manipulating the actual DOM we can run a virtual DOM with React.

1. Describe component state.
   component state is managed within a component

1. Describe props.
   props is what is passed into a component, allows that component to have access to the data retrieved.

1. What are side effects, and how do you sync effects in a React component to changes of certain state or props?
   side effects are any effects that are happening, like changing the DOM in React.
   you can use setVariable to reset a state.
...
- [ NA] The Pokemon API is a slightly harder challenge because a single network request might not be enough to get all the data you need.
